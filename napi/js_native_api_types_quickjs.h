#ifndef SRC_JS_NATIVE_API_TYPES_QUICKJS_H_
#define SRC_JS_NATIVE_API_TYPES_QUICKJS_H_
...
typedef struct napi_extended_error_info__ {

} napi_extended_error_info__;

typedef JSValue napi_value__;
typedef JSValue napi_valuetype__;
